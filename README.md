...
the Delve Modifiers page and one page per ally, mount, wings, boat, sail, aura, Mag Rider, flask, tome, fishing pole, costume, Geode companion,
fish, Delve memento, badge and crafting station (with its recipes), plus one page per style slot (hats, faces, weapons, banners), are generated from the game files, with an editable
...
delve modifiers, companions, fish, mementos, badges, recipes, wings/boats/sails/auras/Mag Riders/flasks/tomes/fishing poles, costumes and styles) has a decoder in `app/trove/decode/`. After the archiver syncs a new live-us patch,
