...
PAGES: tuple[Destination, ...] = (
    ...
    _p("Blueprint Editor", "/blueprint-editor", "blueprint_editor_enabled", "fa-solid fa-cube", "Create", "voxel", "blueprint", "recolour", "recolor", "materials", "glass", "model", "mount", "creature", "parts", badge="Beta"),
