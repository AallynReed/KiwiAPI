...
CODEX_PARSER_VERSION = 25  # v25: multiplicative Critical Damage gets its own stat key ($Stat_CriticalHitDamageBonus, "Critical Damage Bonus") - stat id 0x16 carries two different bonuses that both render as a percentage, and 12 allies scale the crit damage stat rather than adding percentage points to it
